...
import { ConfirmationStepContainer, FadeInContainer, ConfirmationItem, ConfirmationLabel, ConfirmationValue, ConfirmButton } from './ConfirmationStep.styled';
...
const ConfirmationStep: React.FC<ConfirmationStepProps> = (props) => {
  ...
  return (
    <ConfirmationStepContainer onClick={skipAllAnimations}>
      <AnimatedMessage messages={['入力内容を確認してください']} delay={0} skipAll={skipAllAnimations} onComplete={handleComplete} />
      {showForm && (
        <FadeInContainer>
          <ConfirmationItem>
